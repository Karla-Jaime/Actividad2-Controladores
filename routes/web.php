...
Route::get("/admin/noticias/{id}/confirmedelete",[AdminNoticiaController::class, "confirmdelete"])->name("admin.noticias.confirmdelete");
...
Route::get("/admin/blank", [AdminNoticiaController::class, "blank"])->name("admin.noticias.blank");